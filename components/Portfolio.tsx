        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-brand-gray max-w-2xl mx-auto text-lg font-medium">
              Strategic engineering solutions balancing rapid execution with
              ...
              >
                <div className="relative h-72 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-brand-primary/90 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                    <a
                      href={project.link}
                      className="p-4 bg-white text-brand-primary rounded-full hover:scale-110 transition-transform shadow-xl"
                    >
                      <svg
                        width="24"
                        height="24"
                ...
                <div className="p-10">
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tags.slice(0, 3).map((tag) => (
                      <span
                        key={tag}
                        className="px-4 py-1.5 bg-white text-brand-primary text-[10px] font-black uppercase tracking-widest border border-brand-primary/10 rounded-lg"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <a
                    href={project.link}
                    className="inline-flex items-center text-[10px] font-black uppercase tracking-[0.25em] text-black group-hover:text-brand-primary transition-all"
                  >
                    Inspect Project{" "}
