...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-brand-primary">
      {/* Subtle Texture Background */}
      <div className="absolute inset-0 opacity-[0.05] pointer-events-none" style={{ backgroundImage: 'radial-gradient(#fff 1.5px, transparent 0)', backgroundSize: '40px 40px' }}></div>
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="text-center lg:text-left text-white">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.95] mb-8 tracking-tighter">
            Bringing your ideas to <span className="opacity-70">sellable</span> products
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
            I help businesses bring ideas to life by combining AI-assisted development, full-stack engineering, and product thinking—building scalable, revenue-driven web and mobile products that ship, grow, and make money.
          </p>
          ...
          <div className="mt-16 flex items-center justify-center lg:justify-start gap-12 border-t border-white/20 pt-10">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] uppercase tracking-widest font-black mt-1 opacity-70">Delivery Rate</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-black leading-none">X10</span>
              <span className="text-[10px] uppercase tracking-widest font-black mt-1 opacity-70">Dev Velocity</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-black leading-none">AI</span>
              <span className="text-[10px] uppercase tracking-widest font-black mt-1 opacity-70">Native</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex justify-center lg:justify-end">
          ...
          <div className="absolute bottom-10 -left-6 lg:-left-12 p-6 bg-white rounded-3xl shadow-2xl z-20 transform hover:-translate-y-2 transition-transform hidden sm:block">
             <div className="flex items-center gap-4">
               ...
               <div>
                 <p className="text-xs font-black text-black uppercase tracking-tight">Active for projects</p>
                 <p className="text-[10px] font-bold text-neutral-400 uppercase">Remote Engineering</p>
               </div>
             </div>
          </div>
        </div>
