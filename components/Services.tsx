        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-brand-gray text-lg font-medium">
              I offer specialized engineering services to help startups and
              enterprises ship high-quality products faster.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {SERVICES.map((service) => (
              ...
              >
                ...
                <a
                  href="#contact"
                  className="text-[10px] font-black uppercase tracking-widest text-white hover:text-brand-primary transition-all flex items-center gap-2"
                >
                  Inquire <span>→</span>
                </a>
              </div>
          ...
          <div className="mt-20 p-12 bg-white text-black rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl">
            <div>
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase tracking-tighter">
                Ready to build?
              </h3>
              <p className="text-neutral-600 font-medium">
                Let's create a product that makes an impact and scales
                effortlessly.
              </p>
            </div>
            <a
              href="#contact"
              className="px-10 py-4 bg-brand-primary text-white font-black uppercase tracking-widest text-xs rounded-full hover:bg-black transition-all shadow-xl shadow-brand-primary/20"
            >
              Start Consultation
            </a>
          </div>
