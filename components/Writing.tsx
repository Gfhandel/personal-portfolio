    ...
    <section id="writing" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div>
            <h2 className="text-3xl md:text-5xl font-black text-black mb-4 uppercase tracking-tighter">Insights</h2>
            <p className="text-brand-gray text-lg max-w-xl font-medium">
              Thoughts on modern engineering, automation, and product delivery.
            </p>
          </div>
          <a href="#" className="hidden md:block px-6 py-3 border-2 border-black text-black text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-black hover:text-white transition-all">
            All Articles
          </a>
        </div>
        ...
        <a href="#" className="md:hidden mt-8 block w-full text-center px-6 py-4 bg-black text-white text-[10px] font-black uppercase tracking-widest rounded-xl">
          All Articles
        </a>
      </div>
    </section>
